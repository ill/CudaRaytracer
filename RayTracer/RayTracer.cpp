...
RayTracer::RayTracer(const glm::uvec2& resolution)
...
const RayTracer::SphereData* RayTracer::sphereForRay(const glm::vec3& rayOrigin, const glm::vec3& rayDirection, glm::mediump_float& distance, const SphereData* omitSphere) const {
...
void RayTracer::rayTraceScene(const illGraphics::Camera& camera) const {
...
void RayTracer::output(const char * fileName) const {
